//! Single-slot waitqueue which can be split into `Producer` and `Consumer.
//!
//! This module is best used when the HAL you're using expects you to wake tasks yourself
//! inside ISR (like RTIC's model).
